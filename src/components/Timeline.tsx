...
const timelineEvents = [
  {
    ...
    icon: Presentation,
    description:
      "Participants must submit a presentation proposing an idea that addresses at least one Sustainable Development Goal before the specified deadline.",
  },
  {
    id: 2,
    title: "Final Round",
    ...
    icon: Trophy,
    description:
      "Shortlisted teams take the stage to passionately pitch their ideas before a panel of experienced judges, competing for their final selection.",
  },
];
...
const Timeline = () => {
  ...
  return (
    <section
      id="timeline"
      className="py-16 md:py-24 lg:py-32 overflow-x-hidden bg-gradient-to-b from-pink-50 to-pink-100 dark:from-pink-950/80 dark:to-pink-900/80 relative overflow-hidden timeline-section"
    >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-12 p-4 bg-pink-50 dark:bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-foreground">
                      Register on the Hult Prize Platform
                    </h4>
                    <p className="text-muted-foreground text-lg mt-2">
                      Complete your registration on the official Hult Prize
                ...
                <div className="flex items-start gap-12 p-4 bg-pink-50 dark:bg-slate-800/50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg mt-2">
                      Stay updated with all announcements, important dates, and
                      event details.
                    </p>
                    <button
